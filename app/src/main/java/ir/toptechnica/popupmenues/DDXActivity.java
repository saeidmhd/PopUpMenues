...
public class DDXActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent()!=null && getIntent().hasExtra(Intent.EXTRA_TEXT )) {
            ...
            switch(index){
                ...
                case 0:
                    menu_description_text.setText(mModel.getSyndrome_DDX(index));
                    menu_title_text.setText(mModel.getSyndrome_Menu_title(2));
